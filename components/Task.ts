...
export default class Task extends Dom {
  ...
  domElts:
    | {
        ...
        h2Elt: HTMLHeadingElement;
        buttonDeleteElt: HTMLButtonElement;
        buttonValidateElt: HTMLButtonElement;
      }
    | any;

  constructor(id: string, name: string, done: boolean, parent: HTMLElement) {
    super();
    this.id = id;
    this.name = name;
    this.done = done;
